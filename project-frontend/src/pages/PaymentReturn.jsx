          ...
          {localStorage.getItem("token") ? (
            <>
              ...
              <div className="flex gap-4 justify-center">
                <Link
                  to="/"
                  className="px-6 py-2 border-2 border-primary text-primary font-semibold rounded-lg hover:bg-primary-light/10 transition"
                >
                  Về Trang Chủ
                </Link>
                <Link
            ...
            <>
              <p className="text-gray-600 mb-8">
                Nhân viên sẽ liên hệ với bạn sớm nhất có thể để xác nhận thông
                tin giao hàng.
              </p>
              <div className="flex gap-4 justify-center">
                <Link
        ...
        <div className="text-center max-w-md bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
          ...
          <div className="flex flex-col gap-3">
            ...
            {localStorage.getItem("token") ? (
              <Link
                to="/profile?tab=orders"
                className="w-full px-6 py-3 text-gray-500 hover:bg-gray-100 rounded-lg transition font-medium"
              >
