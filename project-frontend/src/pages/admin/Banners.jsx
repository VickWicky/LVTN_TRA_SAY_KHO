  ...
  const fetchBanners = async (page = currentPage, search = debouncedSearch) => {
    ...
    try {
      const res = await fetch(
        `${API_URL}/api/admin/banners?page=${page}&search=${encodeURIComponent(search)}`,
        {
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">
              Thiết lập hình ảnh quảng cáo trang chủ
            </p>
          </div>
                  ...
                  >
                    ...
                    <td className="p-4 text-center relative">
                      ...
                      {openMenuId === banner.id && (
                        <div
                          ref={menuRef}
                          className="absolute right-12 top-10 w-36 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden z-20 animate-fade-in text-left"
                        >
                          <button
                          ...
                          >
                            <i
                              className={`fas ${banner.is_active ? "fa-eye-slash" : "fa-eye"} w-4`}
                            ></i>
          ...
          <div className="relative w-full max-w-md bg-white h-full shadow-2xl flex flex-col animate-slide-in-right">
            ...
            <div className="flex-1 overflow-y-auto p-6 bg-gray-50/30 custom-scrollbar">
              ...
              >
                      ...
                      <div className="mt-2 text-xs text-gray-500">
                        <div className="flex flex-wrap gap-2 mt-2">
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              setFormData({ ...formData, cta_link: "/about" })
                            }
                            className="text-primary hover:underline hover:text-primary/80"
                          >
                            Giới thiệu (/about)
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              setFormData({ ...formData, cta_link: "/contact" })
                            }
                            className="text-primary hover:underline hover:text-primary/80"
                          >
                            Liên hệ (/contact)
                        ...
                        <p className="mt-2 text-gray-500 italic">
                          ...
                          Để điều hướng đến một sản phẩm cụ thể, hãy điền theo
                          cú pháp: <strong>/product/slug-cua-san-pham</strong>{" "}
                          (VD: /product/tra-xanh-thuong-hang)
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm space-y-4">
                  ...
                  <div
                    className="flex items-center gap-3 pt-2 cursor-pointer hover:bg-gray-50 p-2 rounded-lg -ml-2 transition-colors"
                    onClick={() =>
                      setFormData({
                        ...formData,
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-gray-500">
                        Banner sẽ lập tức xuất hiện nếu được bật.
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="px-6 py-4 border-t border-gray-100 bg-white flex justify-end gap-3 z-10 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
              ...
              <button
                ...
                className="px-8 py-2.5 bg-primary text-white rounded-xl font-bold hover:bg-primary-dark shadow-md shadow-primary/30 flex items-center gap-2 transition-all active:scale-95 disabled:opacity-70"
              >
                {isSubmitting ? (
                  <>
                  ...
                  <>
                    <i className="fas fa-save"></i> Lưu Banner
                  </>
                )}
              </button>
            </div>
